...
Este patrón tiene implicaciones metodológicas y prácticas. Las Figuras~\ref{fig:captura-sarima} y \ref{fig:captura-estacional} del capítulo de resultados muestran, bajo idénticos filtros (escenario A), cómo un modelo con mejor ajuste in-sample puede perder frente a SARIMA en la prueba reservada:
