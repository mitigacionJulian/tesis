...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{images/fig_metodologia.png}
...
Dado que el estudio se basa en datos secundarios, no se realiza muestreo probabilístico en sentido tradicional: se trabaja con un enfoque censal sobre la totalidad de los registros disponibles tras el proceso de depuración, lo que reduce sesgos de selección y permite analizar el fenómeno de manera integral \cite{oviedo2025}. Específicamente, el volumen histórico inicial contemplaba 235,843 registros, de los cuales se descartaron 22,971 filas por presentar al menos un valor ausente o nulo (lo que representa el 9.74\% del total). Tras esta depuración, la base de datos final cuenta con un total de 212,872 datos hábiles y completos para el análisis, garantizando la consistencia del modelo. Para fines analíticos, la plataforma aplica filtros temporales, geográficos y categóricos que segmentan esta población en subconjuntos ---periodos, comunas, clases de incidente, rangos con o sin exclusión COVID--- sin constituir muestras independientes, sino estrategias de exploración y evaluación bajo escenarios documentados.
